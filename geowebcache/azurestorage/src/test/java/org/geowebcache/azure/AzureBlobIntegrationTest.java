...
public class AzureBlobIntegrationTest {
    ...
    @Rule
    public TemporaryAzureBlobFolder tempFolder = new TemporaryAzureBlobFolder(testConfigLoader.getProperties());
    ...
    public void before() throws Exception {
        ...
        AzureBlobStoreConfig config = tempFolder.getConfig();
        ...
        blobStore = new AzureBlobStore(config, layers);
    }
